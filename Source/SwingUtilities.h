...
{    
    ...
    /** Convert a string such as "201506101125" to "2015-06-10 11:25".

        The argument must be generated by getCurrentTimeString(), otherwise it will return a String::empty. */
    static const String getTimeStringWithSeparator (const String& dateAndTimeString);

    /** return: 2015-07-28 Mon 23:57:28. The argument must be generated by getCurrentTimeString().
    ...
    /** Return 3 letters weekday name. The argument must be generated by getCurrentTimeString(). */
    ...
    /** if the argument valid and <= current time, then return true.
        ...
        The argument must be generated by getCurrentTimeString(), otherwise it will return false.*/
