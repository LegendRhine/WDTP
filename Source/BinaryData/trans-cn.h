...
"Cleanup all needless medias before regenerate the site?" = "重新生成整个网站之前要清理所有冗余的媒体数据吗？"
"Regenerate Without Cleanup" = "直接生成，不清理"
"Cleanup Before Regenerate" = "先清理，后生成"
...
"Sum Numbers of This Paragraph" = "合计本行的所有数字"
"Average Numbers of This Paragraph" = "求本行数字的平均值"
