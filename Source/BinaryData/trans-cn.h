...
"Open in External Editor..." = "外部编辑器打开..."
"Browse in External Browser..." = "外部浏览器中加载..."
...
"Add to Keywords" = "提取关键词"
"Pickup as Description" = "提取为摘要"
...
"External Translate Selection" = "外部翻译所选内容"
"Font Size..." = "字体大小..."
"Font Color..." = "字体颜色..."
"Backgroud..." = "背景颜色..."
...
"WDTP" = "山湖路"
"Description of this project..." = "项目摘要..."
"Something wrong during create this project file." = "创建项目期间出现错误."
"Something worong during saving this file." = "保存文件期间出现错误."
"Cleanup all needless medias and regenerate the site?" = "确实要清理冗余数据并重新生成整站？"
"The site regenerate successful!" = "整站生成完毕!"
...
"Endnote" = "尾注"
"Endnote(s): " = "尾注："
"Description of this doc..." = "此文档的摘要……"
...
"Identifier" = "标识符"
" Walden Trip is GPL (v2) licensed." =" 本软件遵循GPL (v2)开源协议."
"Total replaced: " = "共替换了 "
" matched in " = " 处, 修改了 "
" file(s)." = " 个文件."
...
"No tips for the selected text." = "智库索引中未找到所选内容."
"Update List..." = "更新记录..."
...
"Line Wrap" = "自动换行"
"Modify Current Theme" = "修改当前主题"
"Set Site Icon" = "设置网站图标"
"Set Project Logo" = "设置项目LOGO"
"Global Stylesheet" = "全局样式表"
"Please select an image" = "请选择一个图像文件"
"Site ico has been set successful!" = "网站图标设置成功!"
"Please select a valid ico image." = "请选择一个有效的ico图像."
"Project logo has been set successful!" = "项目LOGO设置成功!"
"Please select a valid png image." = "请选择一个有效的png图像."
"Click here and 'New Project...'\n\nStart your journey of WDTP!" = "点击此处，新建项目.\n\n开启您的“山·湖·路”之旅!"
"Right-click the root item then\n\n'New Folder' or 'New Document'..." = "鼠标右键点击项目根目录，而后\n\n“新建文件夹”或“新建文档”..."
...
"Rotate Left 90 Degress" = "向左旋转90度"
"Rotate Right 90 Degress" = "向右旋转90度"
"Width Decrease a Quarter" = "宽度减少1/4"
"Half Width" = "宽度减少1/2"
"View Html Code of Current Page" = "查看当前页的HTML源码"
"Hide / Minimize" = "隐藏/最小化"
"Root Path" = "根目录路径"
"Project Logo" = "项目Logo"
"Site Menu" = "网页菜单"
"Site Navigation" = "网页导航"
"Home Text Link" = "首页链接"
"Article Title" = "文章标题"
"Article Description" = "文章摘要"
"Article Content" = "文章内容"
"Create and Modify Time" = "创建和最后修改时间"
"Previous and Next Article" = "上一篇/下一篇"
"Five Random Articles" = "随机推荐（5篇）"
"Advertisement Images" = "广告图片链接"
"Contact Info" = "联系信息"
"Goto Top" = "返回顶部"
"Back to Upper Level" = "返回上一级"
"Copyright Info" = "版权信息"
"Folder Title" = "文件夹标题"
"Blog List" = "博客文章列表"
...
"The tip's name must more than 1 valid character" = "提示名称至少需要两个有效字符"
"Sum Numbers of This Row" = "合计本行的所有数字"
"Average Numbers of This Row" = "求本行数字的平均值"
